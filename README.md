...
Contributions are welcome, e.g. if you develop a useful preprocessing function. Please open an [issue](https://github.com/OHBA-analysis/Canonical-HMM-Networks/issues) or [pull request](https://github.com/OHBA-analysis/Canonical-HMM-Networks/pulls).
