...
def _build_summary(session_dir):
...
def _embed_png(filepath, css_class=""):
...
def _build_step_tab(step_num, step_info, plots_dir, session_ids):
...
def _copy_surface_plots(plots_dir, sessions, output_dir):
...
def generate_report(plots_dir, sessions, output_dir=None,
